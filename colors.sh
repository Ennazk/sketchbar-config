...
# -- Modern White/Transparent Scheme --
export BAR_COLOR=0x00000000        # Transparent bar
export ITEM_BG_COLOR=0x00000000    # Transparent item backgrounds  
export ACCENT_COLOR=0xffffffff     # White for highlights/accents
